                  ...
                  <div class="form-bg" style="padding: 150px 0;">
                    <div class="container">
                      <div class="row">
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo site_url('podcast/edit_action'); ?>">
                          <input type="hidden" name="idUser" value="<?= $podcast->idUser; ?>">
                          <input type="hidden" name="idPodcast" value="<?= $podcast->idPodcast; ?>">
                          ...
                          <div class="form-group">
                            <label>Title</label>
                            <input name="title" type="text" class="form-control" placeholder="User Name" value="<?php echo $podcast->title; ?>">
                          </div>
                          <div class="form-group">
                            <label>Description</label>
                            <input name="description" type="text" class="form-control" placeholder="Description" value="<?php echo $podcast->deskripsi; ?>">
                          </div>

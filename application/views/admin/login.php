      ...
      <div class="row">
        <div class="col-md-offset-3 col-md-8">
          <div class="form-container">
            ...
            <form method="post" action="<?= site_url('admin_login/login_action'); ?>" class="form-horizontal">
              ...
              <div class="form-group mt-5">
                <span class="signin-link">Don't have an account?<br> Click here to <a href="<?= site_url('admin_login/register'); ?>">Sign Up</a></span>

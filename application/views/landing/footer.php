  ...
  <div class="container">
    <footer class="py-5">
      <div class="row">
        ...
        <div class="col-2 pt-5">
          <h5 class="text-light fs-4">Our Team</h5><br>
          <ul class="nav flex-column">
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0  text-light">Dinda Farras G</a></li>
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0  text-light">Oktaviana Arifah W</a></li>
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0  text-light">Ferdinando</a></li>
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0  text-light">Echa Amelya P</a></li>
            <li class="nav-item mb-2"><a href="#" class="nav-link p-0  text-light">Hafid Hanifan</a></li>
          </ul>
        </div>
      </div>
